...
export default function GuestItem({id, name, email, phone, isGoing, cover, cpf, instagram, actionButton=false}: GuestItemProps) {
    return(
        <Container>
            <div className="picture">

                <img src={cover ? cover : NoPhotoImg} alt={"Foto de " + name} className="cover"/>
            </div>
